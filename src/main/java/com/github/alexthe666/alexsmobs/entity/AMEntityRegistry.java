...
public class AMEntityRegistry {
    ...
    private static final TagKey<Block> POWDER_SNOW = TagKey.create(Registries.BLOCK, Identifier.parse("minecraft:powder_snow"));
    ...
    public static final EntityType<EntitySnowLeopard> SNOW_LEOPARD = registerEntity(EntityType.Builder.of(EntitySnowLeopard::new, MobCategory.CREATURE).sized(1.2F, 1.3F).immuneTo(POWDER_SNOW).clientTrackingRange(10), "snow_leopard");
    ...
    public static final EntityType<EntityFroststalker> FROSTSTALKER = registerEntity(EntityType.Builder.of(EntityFroststalker::new, MobCategory.CREATURE).sized(0.95F, 1.15F).immuneTo(POWDER_SNOW), "froststalker");
    ...
    public static final EntityType<EntityTusklin> TUSKLIN = registerEntity(EntityType.Builder.of(EntityTusklin::new, MobCategory.CREATURE).sized(2.2F, 1.9F).immuneTo(POWDER_SNOW).clientTrackingRange(10), "tusklin");
