        ...
        if(this.entity.getSensing().hasLineOfSight(target)){
            ...
            if(dist < 8 && shootCooldown == 0){
                ...
                if (!this.entity.isSilent()) {
                    ...
                    this.entity.level().playSound(null, this.entity.getX(), this.entity.getY(), this.entity.getZ(), AMSoundRegistry.MUDSKIPPER_SPIT, this.entity.getSoundSource(), 1.0F, 1.0F + (this.entity.getRandom().nextFloat() - this.entity.getRandom().nextFloat()) * 0.2F);
                }
