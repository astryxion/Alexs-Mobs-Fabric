...
public class EntityStraddler extends Monster implements IAnimatedEntity {
    ...
    static class LavaPathNavigator extends GroundPathNavigation {
        ...
        protected PathFinder createPathFinder(int p_179679_1_) {
            this.nodeEvaluator = new WalkNodeEvaluator() {
                ...
                public PathType getPathType(PathfindingContext context, int x, int y, int z) {
                    ...
                    if (pathType == PathType.LAVA || pathType == PathType.DAMAGE_CAUTIOUS) {
                        return pathType;
                    }
                    return pathType;
                }
        ...
        public boolean canCutCorner(PathType pathType) {
            return pathType == PathType.LAVA || pathType == PathType.DAMAGE_CAUTIOUS || super.canCutCorner(pathType);
        }
