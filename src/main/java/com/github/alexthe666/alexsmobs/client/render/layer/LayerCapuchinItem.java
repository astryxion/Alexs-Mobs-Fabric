...
public class LayerCapuchinItem extends RenderLayer<CitadelLivingRenderState, AlexAdvancedEntityModel.CitadelEntityModelBridge<EntityCapuchinMonkey, ModelCapuchinMonkey>> {
    ...
    @Override
    public void submit(PoseStack matrixStackIn, SubmitNodeCollector bufferIn, int packedLightIn, CitadelLivingRenderState state, float netHeadYaw, float headPitch) {
        EntityCapuchinMonkey entitylivingbaseIn = state.citadelEntity instanceof EntityCapuchinMonkey m ? m : null;
    ...
    protected void translateToHand(PoseStack matrixStack) {
        ModelCapuchinMonkey model = this.getParentModel().delegate();
