...
public class AMRecipeRegistry {
    ...
    public static void init() {
        MIMICREAM_RECIPE = Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, ResourceLocation.fromNamespaceAndPath(AlexsMobs.MODID, "mimicream_repair"),
                new SimpleCraftingRecipeSerializer<>(RecipeMimicreamRepair::new));
        BISON_UPGRADE = Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, ResourceLocation.fromNamespaceAndPath(AlexsMobs.MODID, "bison_upgrade"),
