...
public class EmeraldsForItemsTrade implements VillagerTrades.ItemListing {
    ...
    public MerchantOffer getOffer(Entity p_221182_1_, RandomSource p_221182_2_) {
        ItemCost costA = new ItemCost(this.tradeItem, 1);
        return new MerchantOffer(costA, new ItemStack(Items.EMERALD, this.count), this.maxUses, this.xpValue, this.priceMultiplier);
    }
}