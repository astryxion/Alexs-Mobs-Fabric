...
public class ItemsForEmeraldsTrade  implements VillagerTrades.ItemListing {
    ...
    public MerchantOffer getOffer(Entity trader, RandomSource rand) {
        ItemCost costA = new ItemCost(Items.EMERALD, this.emeraldCount);
        return new MerchantOffer(costA, new ItemStack(this.sellingItem.getItem(), this.sellingItemCount), this.maxUses, this.xpValue, this.priceMultiplier);
    }
}
