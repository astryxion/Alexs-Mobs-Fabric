    ...
    public static class Deserializer implements JsonDeserializer<CapsidRecipe> {
        ...
        public CapsidRecipe deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            ...
            if (jsonobject.has("result")) {
                ...
                String itemId = JsonUtils.getString(resultObj, "item");
                int count = resultObj.has("count") ? JsonUtils.getInt(resultObj, "count") : 1;
                result = new ItemStack(net.minecraft.core.registries.BuiltInRegistries.ITEM.get(net.minecraft.resources.ResourceLocation.parse(itemId)), count);
            }
