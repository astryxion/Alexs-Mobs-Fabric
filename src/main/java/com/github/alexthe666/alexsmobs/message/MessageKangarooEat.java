...
public class MessageKangarooEat {
    ...
    public static MessageKangarooEat read(FriendlyByteBuf buf, net.minecraft.core.HolderLookup.Provider registryAccess) {
        net.minecraft.nbt.CompoundTag tag = buf.readNbt();
        return new MessageKangarooEat(buf.readInt(), tag != null ? ItemStack.parseOptional(registryAccess, tag) : ItemStack.EMPTY);
    }

    public static void write(MessageKangarooEat message, FriendlyByteBuf buf, net.minecraft.core.HolderLookup.Provider registryAccess) {
    ...
    public static class Handler {
        ...
        public static void handle(MessageKangarooEat message, Supplier<AlexsMobs.PacketContext> context) {
