...
public class MessageMungusBiomeChange {
    ...
    public static class Handler {
        ...
        public static void handle(MessageMungusBiomeChange message, Supplier<AlexsMobs.PacketContext> context) {
            ...
            context.get().enqueueWork(() -> {
                ...
                if (player != null) {
                    if (player.level() != null) {
                        ...
                        Holder<Biome> holder = registry.getHolder(ResourceKey.create(Registries.BIOME, ResourceLocation.parse(message.biomeOption))).orElse(null);
