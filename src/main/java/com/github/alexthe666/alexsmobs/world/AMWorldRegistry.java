...
public class AMWorldRegistry {
    ...
    private static final ResourceKey<PlacedFeature> LEAFCUTTER_ANTHILL_PLACED_KEY = ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(AlexsMobs.MODID, "leafcutter_anthill"));
