...
public final class AMSpawnRegistry {
    ...
    static void addSpawns() {
        ...
        if (AMConfig.mimicubeSpawnWeight > 0 && !AMConfig.mimicubeSpawnInEndCity) addMobSpawn(AMDefaultBiomes.MIMICUBE, MobCategory.MONSTER, AMEntityRegistry.MIMICUBE, AMConfig.mimicubeSpawnWeight, 1, 3);
    ...
    static void addLeafcutterAnthillFeature() {
        ...
        ResourceKey<net.minecraft.world.level.levelgen.placement.PlacedFeature> anthill = ResourceKey.create(
                Registries.PLACED_FEATURE, new ResourceLocation(AlexsMobs.MODID, "leafcutter_anthill"));
        BiomeModifications.create(new ResourceLocation(AlexsMobs.MODID, "leafcutter_anthill"))
