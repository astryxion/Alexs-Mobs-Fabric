...
public class RenderManedWolf extends MobRenderer<EntityManedWolf, ModelManedWolf> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/maned_wolf.png");
    private static final ResourceLocation TEXTURE_ENDER = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/maned_wolf_ender.png");
