...
public class AMItemstackRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    private static final ResourceLocation SHIELD_OF_THE_DEEP_TEXTURE = ResourceLocation.parse("alexsmobs:textures/armor/shield_of_the_deep.png");
    private static final ModelMysteriousWorm MYTERIOUS_WORM_MODEL = new ModelMysteriousWorm();
    private static final ResourceLocation MYTERIOUS_WORM_TEXTURE = ResourceLocation.parse("alexsmobs:textures/item/mysterious_worm_model.png");
    private static final ModelEndPirateAnchor ANCHOR_MODEL = new ModelEndPirateAnchor();
    private static final ResourceLocation ANCHOR_TEXTURE = ResourceLocation.parse("alexsmobs:textures/entity/end_pirate/anchor.png");
    private static final ModelEndPirateAnchorWinch WINCH_MODEL = new ModelEndPirateAnchorWinch();
    private static final ResourceLocation WINCH_TEXTURE = ResourceLocation.parse("alexsmobs:textures/entity/end_pirate/anchor_winch.png");
    private static final ModelEndPirateShipWheel SHIP_WHEEL_MODEL = new ModelEndPirateShipWheel();
    private static final ResourceLocation SHIP_WHEEL_TEXTURE = ResourceLocation.parse("alexsmobs:textures/entity/end_pirate/ship_wheel.png");
    private static final ResourceLocation TRANSMUTATION_TABLE_TEXTURE = ResourceLocation.parse("alexsmobs:textures/entity/farseer/transmutation_table.png");
    private static final ResourceLocation TRANSMUTATION_TABLE_GLOW_TEXTURE = ResourceLocation.parse("alexsmobs:textures/entity/farseer/transmutation_table_glow.png");
    private static final ResourceLocation TRANSMUTATION_TABLE_OVERLAY = ResourceLocation.parse("alexsmobs:textures/entity/farseer/transmutation_table_overlay.png");
    ...
    private static List<ItemStack> getDimensionalCarverShards() {
        if (DIMENSIONAL_CARVER_SHARDS == null || DIMENSIONAL_CARVER_SHARDS.isEmpty()) {
            DIMENSIONAL_CARVER_SHARDS = Util.make(Lists.newArrayList(), (list) -> {
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(ResourceLocation.parse("alexsmobs:dimensional_carver_shard_0"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(ResourceLocation.parse("alexsmobs:dimensional_carver_shard_1"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(ResourceLocation.parse("alexsmobs:dimensional_carver_shard_2"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(ResourceLocation.parse("alexsmobs:dimensional_carver_shard_3"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(ResourceLocation.parse("alexsmobs:dimensional_carver_shard_4"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(ResourceLocation.parse("alexsmobs:dimensional_carver_shard_5"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(ResourceLocation.parse("alexsmobs:dimensional_carver_shard_6"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(ResourceLocation.parse("alexsmobs:dimensional_carver_shard_7"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(ResourceLocation.parse("alexsmobs:dimensional_carver_shard_8"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(ResourceLocation.parse("alexsmobs:dimensional_carver_shard_9"))));
                list.add(new ItemStack(BuiltInRegistries.ITEM.get(ResourceLocation.parse("alexsmobs:dimensional_carver_shard_10"))));
            });
        }
    ...
    public void renderByItem(ItemStack itemStackIn, ItemDisplayContext transformType, PoseStack matrixStackIn, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
        ...
        if (itemStackIn.getItem() == AMItemRegistry.SHIELD_OF_THE_DEEP) {
            ...
            VertexConsumer vertexconsumer = ItemRenderer.getArmorFoilBuffer(bufferIn, RenderType.armorCutoutNoCull(SHIELD_OF_THE_DEEP_TEXTURE), itemStackIn.hasFoil());
            SHIELD_OF_THE_DEEP_MODEL.renderToBuffer(matrixStackIn, vertexconsumer, combinedLightIn, combinedOverlayIn, 0xFFFFFFFF);
        ...
        if (itemStackIn.getItem() == AMItemRegistry.MYSTERIOUS_WORM) {
            ...
            MYTERIOUS_WORM_MODEL.renderToBuffer(matrixStackIn, bufferIn.getBuffer(RenderType.entityCutoutNoCull(MYTERIOUS_WORM_TEXTURE)), combinedLightIn, combinedOverlayIn, 0xFFFFFFFF);
            matrixStackIn.popPose();
        }
        if (itemStackIn.getItem() == AMItemRegistry.FALCONRY_GLOVE) {
            ...
            if (transformType == ItemDisplayContext.THIRD_PERSON_LEFT_HAND || transformType == ItemDisplayContext.THIRD_PERSON_RIGHT_HAND || transformType == ItemDisplayContext.FIRST_PERSON_RIGHT_HAND || transformType == ItemDisplayContext.FIRST_PERSON_LEFT_HAND) {
                Minecraft.getInstance().getItemRenderer().renderStatic(new ItemStack(AMItemRegistry.FALCONRY_GLOVE_HAND), transformType, combinedLightIn, combinedOverlayIn, matrixStackIn, bufferIn, level, 0);
            } else {
                Minecraft.getInstance().getItemRenderer().renderStatic(new ItemStack(AMItemRegistry.FALCONRY_GLOVE_INVENTORY), transformType, transformType == ItemDisplayContext.GROUND ? combinedLightIn : 240, combinedOverlayIn, matrixStackIn, bufferIn, level, 0);
            }
        }
        if (itemStackIn.getItem() == AMItemRegistry.VINE_LASSO) {
            ...
            if (transformType == ItemDisplayContext.THIRD_PERSON_LEFT_HAND || transformType == ItemDisplayContext.THIRD_PERSON_RIGHT_HAND || transformType == ItemDisplayContext.FIRST_PERSON_RIGHT_HAND || transformType == ItemDisplayContext.FIRST_PERSON_LEFT_HAND) {
                if (ItemVineLasso.isItemInUse(itemStackIn)) {
                    ...
                    matrixStackIn.mulPose(Axis.YP.rotation(tick + Minecraft.getInstance().getTimer().getGameTimeDeltaPartialTick(false)));
                }
                Minecraft.getInstance().getItemRenderer().renderStatic(new ItemStack(AMItemRegistry.VINE_LASSO_HAND), transformType, combinedLightIn, combinedOverlayIn, matrixStackIn, bufferIn, level, 0);
            } else {
                Minecraft.getInstance().getItemRenderer().renderStatic(new ItemStack(AMItemRegistry.VINE_LASSO_INVENTORY), transformType, transformType == ItemDisplayContext.GROUND ? combinedLightIn : 240, combinedOverlayIn, matrixStackIn, bufferIn, level, 0);
            }
        }
        if (itemStackIn.getItem() == AMItemRegistry.SKELEWAG_SWORD) {
            ...
            var customData = itemStackIn.get(DataComponents.CUSTOM_DATA);
            if (customData != null) {
                spriteItem.set(DataComponents.CUSTOM_DATA, customData);
                handItem.set(DataComponents.CUSTOM_DATA, customData);
            }
            if (transformType == ItemDisplayContext.THIRD_PERSON_LEFT_HAND || transformType == ItemDisplayContext.THIRD_PERSON_RIGHT_HAND || transformType == ItemDisplayContext.FIRST_PERSON_RIGHT_HAND || transformType == ItemDisplayContext.FIRST_PERSON_LEFT_HAND) {
        ...
        if (itemStackIn.getItem() == AMBlockRegistry.TRANSMUTATION_TABLE.asItem()) {
            ...
            TRANSMUTATION_TABLE_MODEL.renderToBuffer(matrixStackIn, bufferIn.getBuffer(RenderType.entityCutoutNoCull(TRANSMUTATION_TABLE_TEXTURE)), combinedLightIn, combinedOverlayIn, 0xFFFFFFFF);
            TRANSMUTATION_TABLE_MODEL.renderToBuffer(matrixStackIn, bufferIn.getBuffer(RenderType.entityTranslucentEmissive(TRANSMUTATION_TABLE_GLOW_TEXTURE)), combinedLightIn, combinedOverlayIn, 0xFFFFFFFF);
            ...
            TRANSMUTATION_TABLE_OVERLAY_MODEL.renderToBuffer(matrixStackIn, staticyOverlay, combinedLightIn, combinedOverlayIn, 0xFFFFFFFF);
            matrixStackIn.popPose();
        }
        ...
        if (itemStackIn.getItem() == AMItemRegistry.STINK_RAY) {
            matrixStackIn.translate(0.5F, 0.5f, 0.5f);
            ItemStack hand = new ItemStack(ItemStinkRay.isUsable(itemStackIn) ? AMItemRegistry.STINK_RAY_HAND : AMItemRegistry.STINK_RAY_EMPTY_HAND);
            ItemStack inventory = new ItemStack(ItemStinkRay.isUsable(itemStackIn) ? AMItemRegistry.STINK_RAY_INVENTORY : AMItemRegistry.STINK_RAY_EMPTY_INVENTORY);
            if (transformType == ItemDisplayContext.THIRD_PERSON_LEFT_HAND || transformType == ItemDisplayContext.THIRD_PERSON_RIGHT_HAND || transformType == ItemDisplayContext.FIRST_PERSON_RIGHT_HAND || transformType == ItemDisplayContext.FIRST_PERSON_LEFT_HAND) {
        ...
        if(itemStackIn.getItem() == AMBlockRegistry.END_PIRATE_ANCHOR.asItem()){
            ...
            ANCHOR_MODEL.renderToBuffer(matrixStackIn, bufferIn.getBuffer(RenderType.entityCutoutNoCull(ANCHOR_TEXTURE)), combinedLightIn, combinedOverlayIn, 0xFFFFFFFF);
            matrixStackIn.popPose();
        }
        if(itemStackIn.getItem() == AMBlockRegistry.END_PIRATE_ANCHOR_WINCH.asItem()){
            ...
            WINCH_MODEL.renderToBuffer(matrixStackIn, bufferIn.getBuffer(RenderType.entityCutoutNoCull(WINCH_TEXTURE)), combinedLightIn, combinedOverlayIn, 0xFFFFFFFF);
            matrixStackIn.popPose();
        }
        if(itemStackIn.getItem() == AMBlockRegistry.END_PIRATE_SHIP_WHEEL.asItem()){
            ...
            SHIP_WHEEL_MODEL.renderToBuffer(matrixStackIn, bufferIn.getBuffer(RenderType.entityCutoutNoCull(SHIP_WHEEL_TEXTURE)), combinedLightIn, combinedOverlayIn, 0xFFFFFFFF);
            matrixStackIn.popPose();
        }
        */
        if (itemStackIn.getItem() == AMItemRegistry.TAB_ICON) {
            ...
            if (levelForEntity != null) {
                if (ItemTabIcon.hasCustomEntityDisplay(itemStackIn)) {
                    CompoundTag tag = itemStackIn.get(DataComponents.CUSTOM_DATA) != null ? itemStackIn.get(DataComponents.CUSTOM_DATA).copyTag() : null;
                    ...
                    if (this.renderedEntites.get(index) == null && !blockedRenderEntities.contains(local)) {
                        try {
                            Entity entity = local.create(levelForEntity);
                    ...
                    if (type != null) {
                        if (this.renderedEntites.get(type.getDescriptionId()) == null && !blockedRenderEntities.contains(type)) {
                            try {
                                Entity entity = type.create(levelForEntity);
                                if (entity instanceof EntityBlobfish) {
                                    ((EntityBlobfish) entity).setDepressurized(true);
                                }
