...
public class RenderJerboa extends MobRenderer<EntityJerboa, ModelJerboa> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/jerboa.png");
    private static final ResourceLocation TEXTURE_SLEEPING = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/jerboa_sleeping.png");
