...
public class RenderCatfish extends MobRenderer<EntityCatfish, EntityModel<EntityCatfish>> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/catfish_small.png");
    private static final ResourceLocation TEXTURE_MEDIUM = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/catfish_medium.png");
    private static final ResourceLocation TEXTURE_LARGE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/catfish_large.png");
    private static final ResourceLocation TEXTURE_SPIT = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/catfish_small_spit.png");
    private static final ResourceLocation TEXTURE_SPIT_MEDIUM = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/catfish_medium_spit.png");
    private static final ResourceLocation TEXTURE_SPIT_LARGE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/catfish_large_spit.png");
