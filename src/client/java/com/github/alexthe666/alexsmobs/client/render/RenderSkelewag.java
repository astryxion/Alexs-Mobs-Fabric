...
public class RenderSkelewag extends MobRenderer<EntitySkelewag, ModelSkelewag> {
    private static final ResourceLocation TEXTURE_0 = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/skelewag_0.png");
    private static final ResourceLocation TEXTURE_1 = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/skelewag_1.png");
