...
public class RenderCachalotWhale extends MobRenderer<EntityCachalotWhale, ModelCachalotWhale> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/cachalot/cachalot_whale.png");
    private static final ResourceLocation TEXTURE_SLEEPING = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/cachalot/cachalot_whale_sleeping.png");
    private static final ResourceLocation TEXTURE_ALBINO = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/cachalot/cachalot_whale_albino.png");
    private static final ResourceLocation TEXTURE_ALBINO_SLEEPING = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/cachalot/cachalot_whale_albino_sleeping.png");
