...
public class RenderGeladaMonkey extends MobRenderer<EntityGeladaMonkey, ModelGeladaMonkey> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/gelada_monkey.png");
    private static final ResourceLocation TEXTURE_ANGRY = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/gelada_monkey_angry.png");
    private static final ResourceLocation TEXTURE_LEADER = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/gelada_monkey_leader.png");
    private static final ResourceLocation TEXTURE_LEADER_ANGRY = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/gelada_monkey_leader_angry.png");
