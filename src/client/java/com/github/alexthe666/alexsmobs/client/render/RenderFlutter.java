...
public class RenderFlutter extends MobRenderer<EntityFlutter, EntityModel<EntityFlutter>> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/flutter.png");
    private static final ResourceLocation TEXTURE_EYES = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/flutter_eyes.png");
