...
public class RenderRoadrunner extends MobRenderer<EntityRoadrunner, ModelRoadrunner> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/roadrunner.png");
    private static final ResourceLocation TEXTURE_MEEP = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/roadrunner_meep.png");
