...
public class RenderTarantulaHawk extends MobRenderer<EntityTarantulaHawk, EntityModel<EntityTarantulaHawk>> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/tarantula_hawk.png");
    private static final ResourceLocation TEXTURE_ANGRY = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/tarantula_hawk_angry.png");
    private static final ResourceLocation TEXTURE_NETHER = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/tarantula_hawk_nether.png");
    private static final ResourceLocation TEXTURE_NETHER_ANGRY = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/tarantula_hawk_nether_angry.png");
    private static final ResourceLocation TEXTURE_BABY = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/tarantula_hawk_baby.png");
