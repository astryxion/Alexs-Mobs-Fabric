...
public class RenderBoneSerpentPart extends LivingEntityRenderer<EntityBoneSerpentPart, AdvancedEntityModel<EntityBoneSerpentPart>> {
    private static final ResourceLocation TEXTURE_BODY = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/bone_serpent_mid.png");
    private static final ResourceLocation TEXTURE_TAIL = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/bone_serpent_tail.png");
