...
public class RenderGorilla extends MobRenderer<EntityGorilla, ModelGorilla> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/gorilla.png");
    private static final ResourceLocation TEXTURE_SILVERBACK = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/gorilla_silverback.png");
    private static final ResourceLocation TEXTURE_DK = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/gorilla_dk.png");
    private static final ResourceLocation TEXTURE_FUNKY = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/gorilla_funky.png");
