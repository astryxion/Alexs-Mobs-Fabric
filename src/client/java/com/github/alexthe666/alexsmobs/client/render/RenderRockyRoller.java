...
public class RenderRockyRoller extends MobRenderer<EntityRockyRoller, ModelRockyRoller> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/rocky_roller.png");
    private static final ResourceLocation TEXTURE_ANGRY = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/rocky_roller_angry.png");
    private static final ResourceLocation TEXTURE_ROLLING = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/rocky_roller_rolling.png");
