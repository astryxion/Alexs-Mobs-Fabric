...
public class RenderMudskipper extends MobRenderer<EntityMudskipper, ModelMudskipper> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/mudskipper.png");
    private static final ResourceLocation TEXTURE_SPIT = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/mudskipper_spit.png");
