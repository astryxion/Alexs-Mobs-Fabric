...
public class RenderTiger extends MobRenderer<EntityTiger, ModelTiger> {
    ...
    private static final ResourceLocation TEXTURE_ANGRY = ResourceLocation.parse("alexsmobs:textures/entity/tiger/tiger_angry.png");
    private static final ResourceLocation TEXTURE_SLEEPING = ResourceLocation.parse("alexsmobs:textures/entity/tiger/tiger_sleeping.png");
    private static final ResourceLocation TEXTURE_WHITE = ResourceLocation.parse("alexsmobs:textures/entity/tiger/tiger_white.png");
    private static final ResourceLocation TEXTURE_ANGRY_WHITE = ResourceLocation.parse("alexsmobs:textures/entity/tiger/tiger_white_angry.png");
    private static final ResourceLocation TEXTURE_SLEEPING_WHITE = ResourceLocation.parse("alexsmobs:textures/entity/tiger/tiger_white_sleeping.png");
    ...
    public void render(EntityTiger entityIn, float entityYaw, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
        ...
        if (rendertype != null) {
            ...
            this.model.renderToBuffer(matrixStackIn, ivertexbuilder, packedLightIn, i, ((int)(alpha * 255) << 24) | 0x00FFFFFF);
        }
    ...
    /** Fabric 1.20.1: Entity.shouldRiderSit() not in API; use reflection for 1:1. */
    private static boolean getShouldRiderSit(Entity entity) {
        try {
