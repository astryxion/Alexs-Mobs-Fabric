...
public class RenderUnderminer extends MobRenderer<EntityUnderminer, EntityModel<EntityUnderminer>> {
    private static final ResourceLocation TEXTURE_DWARF = ResourceLocation.parse("alexsmobs:textures/entity/underminer_dwarf.png");
    private static final ResourceLocation TEXTURE_0 = ResourceLocation.parse("alexsmobs:textures/entity/underminer_0.png");
    private static final ResourceLocation TEXTURE_1 = ResourceLocation.parse("alexsmobs:textures/entity/underminer_1.png");
    public static final List<ResourceLocation> BREAKING_LOCATIONS = IntStream.range(0, 10).mapToObj((destroyStage) -> ResourceLocation.parse("alexsmobs:textures/block/ghostly_pickaxe/destroy_stage_" + destroyStage + ".png")).collect(Collectors.toList());
    ...
    private void renderUnderminerModel(PoseStack matrixStackIn, MultiBufferSource source, RenderType defRenderType, float partialTicks, int packedLightIn, int overlayColors, float alphaIn, EntityUnderminer entityIn) {
        ...
        int packed = ((int)(alphaIn * 255) << 24) | ((int)((hurt ? 0.4F : 1.0F) * 255) << 16) | ((int)((hurt ? 0.8F : 1.0F) * 255) << 8) | (int)((hurt ? 0.7F : 1.0F) * 255);
        this.model.renderToBuffer(matrixStackIn, source.getBuffer(defRenderType), packedLightIn, LivingEntityRenderer.getOverlayCoords(entityIn, 0.0F), packed);
    }
    ...
    public static boolean getShouldRiderSit(Entity entity) {
        try {
            java.lang.reflect.Method m = Entity.class.getDeclaredMethod("shouldRiderSit");
