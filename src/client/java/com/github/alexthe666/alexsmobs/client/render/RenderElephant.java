...
public class RenderElephant extends MobRenderer<EntityElephant, ModelElephant> {
    private static final ResourceLocation TEXTURE_TUSK = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/elephant/elephant_tusks.png");
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/elephant/elephant.png");
