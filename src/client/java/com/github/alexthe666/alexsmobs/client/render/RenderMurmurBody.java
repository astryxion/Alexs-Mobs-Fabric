        ...
        if (renderWithHead || body.shouldRenderFakeHead()) {
            ...
            try {
                ...
                try {
                    ...
                    HEAD_MODEL.renderToBuffer(matrixStackIn, bufferIn.getBuffer(RenderType.entityCutoutNoCull(loc)), packedLightIn, overlayCoords, 0xFFFFFFFF);
                    matrixStackIn.translate(0, 0.5F, 0);
                    NECK_MODEL.resetToDefaultPose();
                    NECK_MODEL.setAttributes(0.5F, 0, 0, 0);
                    NECK_MODEL.renderToBuffer(matrixStackIn, bufferIn.getBuffer(RenderType.entityCutoutNoCull(loc)), packedLightIn, overlayCoords, 0xFFFFFFFF);
                } finally {
