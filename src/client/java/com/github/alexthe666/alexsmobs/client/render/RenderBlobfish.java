...
public class RenderBlobfish extends MobRenderer<EntityBlobfish, EntityModel<EntityBlobfish>> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/blobfish.png");
    private static final ResourceLocation TEXTURE_DEPRESSURIZED = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/blobfish_depressurized.png");
