...
public class RenderAnaconda extends MobRenderer<EntityAnaconda, ModelAnaconda<EntityAnaconda>> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/anaconda.png");
    private static final ResourceLocation TEXTURE_SHEDDING = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/anaconda_shedding.png");
    private static final ResourceLocation TEXTURE_YELLOW = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/anaconda_yellow.png");
    private static final ResourceLocation TEXTURE_YELLOW_SHEDDING = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/anaconda_yellow_shedding.png");
