...
public class RenderAnteater extends MobRenderer<EntityAnteater, ModelAnteater> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/anteater.png");
    private static final ResourceLocation TEXTURE_PETER = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/anteater_peter.png");
