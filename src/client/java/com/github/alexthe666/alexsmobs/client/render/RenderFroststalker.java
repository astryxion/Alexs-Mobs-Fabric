...
public class RenderFroststalker extends MobRenderer<EntityFroststalker, ModelFroststalker> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/froststalker.png");
    private static final ResourceLocation TEXTURE_NOSPIKES = ResourceLocation.fromNamespaceAndPath("alexsmobs", "textures/entity/froststalker_nospikes.png");
